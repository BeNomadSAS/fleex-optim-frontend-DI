...
bemap-js-api/           # Vendored BeNomad SDK v2.0.0 (Leaflet + MapLibre bindings, geocoder, tiles). Tile requests are cacheable HTTP-200 (browser HTTP cache); no companion Service Worker.
